<x-layout>
    ...
    <x-card class="mx-auto mt-24 max-w-lg rounded border border-gray-200 bg-gray-50 p-10">
        ...
        <form action="">
            <div class="mb-6">
                <label for="company" class="mb-2 inline-block text-lg">Player Name</label>
                <input type="text" class="w-full rounded border border-gray-200 p-2" name="name" />
            </div>

            <div class="mb-6">
                <label for="title" class="mb-2 inline-block text-lg">Appearances (plus subs)</label>
                <input type="number" class="w-full rounded border border-gray-200 p-2" name="appearances"
                    placeholder="Example: Senior Laravel Developer" />
            </div>

            <div class="mb-6">
                <label for="location" class="mb-2 inline-block text-lg">Goals</label>
            ...
            <div class="mb-6">
                ...
                <input type="url" class="w-full rounded border border-gray-200 p-2" name="website" />
            </div>
